...
def eval_model(
	...
	metrics = {
		"kappa2": {
			...
			"relerr": kappa2_metrics[6],
			"relerr5": kappa2_metrics[7],
			"relerr95": kappa2_metrics[8],
		},
		"theta": {
			...
			"relerr": theta_metrics[6],
			"relerr5": theta_metrics[7],
			"relerr95": theta_metrics[8],
		},
		"rho": {
			"rmse": rho_metrics[0],
			"mae": rho_metrics[1],
			...
			"psnr": rho_metrics[4],
			"nrmse": rho_metrics[5],
			"relerr": rho_metrics[6],
			"relerr5": rho_metrics[7],
			"relerr95": rho_metrics[8],
		},
	}
